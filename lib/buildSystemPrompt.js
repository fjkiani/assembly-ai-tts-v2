...
` : speaker === 'candidate' ? `
CANDIDATE IS SPEAKING — SUPPORT MODE:
...
[DELIVERY]
(One sentence: Tone/pacing/body-language. Focus on collaborative authority.)

[THE MOVE]
- The cohesive technical/architectural answer — REASON about the question, then cite relevant experience as proof
...
- NEVER just list resume bullet points. Formulate a cohesive, reasoned answer that weaves in experience naturally.
`;
}
